...
class ATTACKKnowledgeService:
    ...
    def _load_compatibility_catalog(self) -> None:
        entries = {
            ...
            "T1557": ("Adversary-in-the-Middle", ("TA0006",)),
            "T1557.001": ("LLMNR / NBT-NS Poisoning and SMB Relay", ("TA0006",)),
            "T1557.002": ("ARP Cache Poisoning", ("TA0006",)),
            ...
            "T1550.002": ("Pass the Hash", ("TA0008",)),
